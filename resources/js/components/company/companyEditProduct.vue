...
export default {
  ...
  created() {
    ...
    this.addProductSellerForm.sku = JSON.parse(
      this.$route.params.product
    ).companies_product[0].sku;
    this.addProductSellerForm.price = JSON.parse(
      this.$route.params.product
    ).companies_product[0].price;
    this.addProductSellerForm.minOrderCount = JSON.parse(
      this.$route.params.product
    ).companies_product[0].min_order_count;
  },
